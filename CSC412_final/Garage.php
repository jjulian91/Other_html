...
<html>
 ...
 <div class="col-lg-12 text-center v-center">
             <h1 class="" contenteditable="false">Recommended Gear</h1>
             <h1 class="sub">Each section provides details on what key things to look for as well as what
          I have in my garage currently.</h1>
             <br class="">
          </div>
    </div>
    <!-- /row -->
...
foreach ($json_a as $Location => $Location_item) {
    ...
    if (isset($Location_item['image_url']) && isset($Location_item['id']))
    {
      ...
      echo "<img class=\"frame\" src=\"" .$Location_item['image_url']. "\" onclick=\"document.location='http://".$_SERVER['HTTP_HOST'].$_SERVER['CONTEXT_PREFIX']."/Garage_details.php?id=".$Location_item['id']."'\">";

      if (isset($Location_item['description']))
      {
        echo "<figcaption>" .$Location_item['description'].  "</figcaption>";
        echo "</figure>";
      }
